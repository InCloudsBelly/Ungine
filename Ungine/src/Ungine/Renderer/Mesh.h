...
namespace U 
{
	...
	struct AnimatedVertex
	{
		...
		void AddBoneData(uint32_t BoneID, float Weight)
		{
			...
			U_CORE_WARN("Vertex has more than four bones/weights affecting it, extra data will be discarded (BoneID={0}, Weight={1})", BoneID, Weight);
		}
	};
	...
	struct VertexBoneData
	{
		...
		void AddBoneData(uint32_t BoneID, float Weight)
		{
			...
			U_CORE_ASSERT(false, "Too many bones!");
		}
	};
	...
	private:
		...
		glm::vec3 InterpolateTranslation(float anmationTime, const aiNodeAnim* nodeAnim);
