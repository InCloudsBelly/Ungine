...
public:
	...
	virtual void OnAttach() override
	{
		...
		m_MeshMaterial.reset(new U::MaterialInstance(m_Mesh->GetMaterial()));

		m_QuadShader = U::Shader::Create("assets/shaders/quad.glsl");
		m_HDRShader = U::Shader::Create("assets/shaders/hdr.glsl");

		m_SphereMesh.reset(new U::Mesh("assets/models/Sphere1m.fbx"));
		m_PlaneMesh.reset(new U::Mesh("assets/models/Plane1m.obj"));


		m_GridShader = U::Shader::Create("assets/shaders/Grid.glsl");
		m_GridMaterial = U::MaterialInstance::Create(U::Material::Create(m_GridShader));
		...
		for (int i = 0; i < 8; i++)
		{
			U::Ref<U::MaterialInstance> mi(new U::MaterialInstance(m_SphereMesh->GetMaterial()));
...
private:
	U::Ref<U::Shader> m_QuadShader;
	U::Ref<U::Shader> m_HDRShader;
	U::Ref<U::Shader> m_GridShader;
	U::Ref<U::Mesh> m_Mesh;
	U::Ref<U::Mesh> m_SphereMesh, m_PlaneMesh;
	U::Ref<U::Texture2D> m_BRDFLUT;

	U::Ref<U::MaterialInstance> m_MeshMaterial;
	U::Ref<U::MaterialInstance> m_GridMaterial;
